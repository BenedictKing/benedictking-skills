...
2. Search: `node scripts/context7-api.cjs search "react" "useEffect fetch data"`
3. Select: `/facebook/react/v19.0.0` (version match)
4. Fetch: `node scripts/context7-api.cjs context "/facebook/react/v19.0.0" "useEffect data fetching"`
...
2. Search: `node scripts/context7-api.cjs search "next.js" "middleware configuration"`
3. Select: `/vercel/next.js/v15.1.8`
4. Fetch: `node scripts/context7-api.cjs context "/vercel/next.js/v15.1.8" "middleware"`
...
2. Search: `node scripts/context7-api.cjs search "prisma" "one-to-many relations"`
3. Select: `/prisma/prisma` (highest trust score)
4. Fetch: `node scripts/context7-api.cjs context "/prisma/prisma" "one-to-many relations"`
